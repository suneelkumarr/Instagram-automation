...
const analyticsEventSchema = new mongoose_1.Schema({
    ...
    instagramAccountId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'InstagramAccount', index: true },
    event: { type: String, required: true, index: true },
    automationId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Automation', index: true },
    contactId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Contact', index: true },
